...
export const preloadedDatasets: Record<string, Dataset> = {
  "act-50": {
    ...
    "data": [
      ...
      { "name": "Critical thinking", "description": "Evaluate claims and arguments using logic and evidence; actively seek disconfirming information.", "category": "Wisdom, Truth & Learning" },
      { "name": "Rationality", "description": "Make beliefs and choices that align with goals and evidence under uncertainty (update with new evidence; use expected-value/“what works” thinking).", "category": "Wisdom, Truth & Learning" },
